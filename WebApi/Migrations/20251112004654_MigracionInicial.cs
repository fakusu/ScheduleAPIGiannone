        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EstadisticasUsuarios_User_IdUsuario",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValorGanadoXP = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistorialTareas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistorialTareas_Tareas_IdTarea",
                        column: x => x.IdTarea,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuariosPorTareas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsuariosPorTareas_Tareas_IdTarea",
                        column: x => x.IdTarea,
                        principalTable: "Tareas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_UsuariosPorTareas_User_IdUsuario",
                        column: x => x.IdUsuario,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsuariosPorTareas_IdTarea",
                table: "UsuariosPorTareas",
                column: "IdTarea");

            migrationBuilder.CreateIndex(
                name: "IX_UsuariosPorTareas_IdUsuario",
                table: "UsuariosPorTareas",
                column: "IdUsuario");
        }
